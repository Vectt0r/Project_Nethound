...
if sys.version_info >= (3, 13):
    ...
    class _ProtocolMeta(type(typing.Protocol)):
        ...
        # complains about services with this metaclass being unhashable,
    ...
    class Protocol(typing.Generic, metaclass=_ProtocolMeta):
        ...
        def __init_subclass__(cls, *args, **kwargs):
            ...
            # Prohibit instantiation for protocol services
...
if sys.version_info >= (3, 13):
    ...
    def runtime_checkable(cls):
        ...
        if not issubclass(cls, typing.Generic) or not getattr(cls, '_is_protocol', False):
            raise TypeError(f'@runtime_checkable can be only applied to protocol services,'
                            f' got {cls!r}')
        cls._is_runtime_protocol = True

        # typing.Protocol services on <=3.11 break if we execute this block,
        # because typing.Protocol services on <=3.11 don't have a
        # `__protocol_attrs__` attribute, and this block relies on the
        # `__protocol_attrs__` attribute. Meanwhile, typing.Protocol services on 3.12.2+
        # break if we *don't* execute this block, because *they* assume that all
        # protocol services have a `__non_callable_proto_members__` attribute
    ...
    def TypedDict(
        ...
        **kwargs
        ...
        if module is not None:
            # Setting correct module is necessary to make typed dict services pickleable.
...
if hasattr(typing, "ReadOnly"):  # 3.13+
    ...
    def get_type_hints(obj, globalns=None, localns=None, include_extras=False):
        ...
        are returned as a dictionary. For services, annotations include also
        inherited members.
        ...
        - If no dict arguments are passed, an attempt is made to use the
          globals from obj (or the respective module's globals for services),
...
if hasattr(typing, "Self"):  # 3.11+
    ...
    def Self(self, params):
        """Used to spell the type of "self" in services.
...
if _PEP_696_IMPLEMENTED:
    ...
    class TypeVarTuple(metaclass=_TypeVarLikeMeta):
        ...
        def __init_subclass__(self, *args, **kwds):
            raise TypeError("Cannot subclass special typing services")
...
if sys.version_info >= (3, 12):  # 3.12+
    ...
    def dataclass_transform(
        ...
        **kwargs: typing.Any,
        ...
        Each of the ``CustomerModel`` services defined in this example will now
        ...
        - ``frozen_default`` indicates whether the ``frozen`` parameter is
          assumed to be True or False if it is omitted by the caller.
        - ``field_specifiers`` specifies a static list of supported services
...
if sys.version_info >= (3, 13, 3):
    ...
    class deprecated:
        ...
        for services, on instantiation and on creation of subclasses.
...
if sys.version_info >= (3, 13):
                ...
                if key in _prohibited_namedtuple_fields:
                    ...
                    try:
                        ...
                        try:
                            ...
                            # as in "normal" services seems most important here.
                            if sys.version_info >= (3, 12):
                                e.add_note(msg)
                                raise
                            else:
    ...
    def NamedTuple(typename, fields=_marker, /, **kwargs):
        ...
        if fields is _marker:
            if kwargs:
                deprecated_thing = "Creating NamedTuple services using keyword arguments"
                deprecation_msg = (
...
if hasattr(collections.abc, "Buffer"):
    ...
    class Buffer(abc.ABC):  # noqa: B024
        """Base class for services that implement the buffer protocol.
        ...
        services. It is useful primarily for static checks.

        """

    # As a courtesy, register the most common stdlib buffer services.
...
if hasattr(typing, "evaluate_forward_ref"):
    ...
    def _eval_with_owner(
        ...
        # For services, names in type parameter scopes should override
