"""This module includes services and functions designed specifically for use with the mypy plugin."""
...
class PydanticModelTransformer:
    ...
    def collect_config(self) -> ModelConfigData:  # noqa: C901 (ignore complexity)
        """Collects the values of the config attributes that are used by the plugin, accounting for parent services."""
        cls = self._cls
    ...
    def collect_fields_and_class_vars(
        ...
        """Collects the fields for the model, accounting for parent services."""
        cls = self._cls
