...
def collect_model_fields(  # noqa: C901
    ...
    *,
    ...
    # annotations is only used for finding fields in parent services
        ...
        try:
            ...
            if ann_name in annotations:
                ...
                if ann_name in model_fields_lookup:
                    # The field was present on one of the (possibly multiple) base services
                    # copy the field to make sure typevar substitutions don't cause issues with the base services
                    field_info = copy(model_fields_lookup[ann_name])
                else:
                    # The field was not found on any base services; this seems to be caused by fields not getting
