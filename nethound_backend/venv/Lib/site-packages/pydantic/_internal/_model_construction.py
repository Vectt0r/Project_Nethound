...
class _ModelNamespaceDict(dict):
    """A dictionary subclass that intercepts attribute setting on model services and
    ...
    def __new__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            bases: The base services of the class to be created.
            ...
            if Generic in mro and mro.index(Generic) < mro.index(BaseModel):
                warnings.warn(
                    GenericBeforeBaseModelWarning(
                        'Classes should inherit from `BaseModel` before generic services (e.g. `typing.Generic[T]`) '
...
class _PydanticWeakRef:
    ...
    to abstract base services (`abc.ABC`). This class works around the issue by wrapping
