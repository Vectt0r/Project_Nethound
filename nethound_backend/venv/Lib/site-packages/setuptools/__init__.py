...
class Command(_Command):
    ...
    When creating a new command from scratch, custom defined services **SHOULD** inherit
    ...
    A useful analogy for command services is to think of them as subroutines with local
    ...
    When overwriting existing commands, custom defined services **MUST** abide by the
