...
# 3.7
    ...
    class Protocol(metaclass=_ProtocolMeta):
        ...
        """Base class for protocol services. Protocol services are defined as::

            class Proto(Protocol):
                def meth(self) -> int:
                    ...

        Such services are primarily used with static type checkers that recognize
        ...
        See PEP 544 for details. Protocol services decorated with
        @typing_extensions.runtime act as simple-minded runtime protocol that checks
        only the presence of given attributes, ignoring their type signatures.

        Protocol services can be generic, they are defined as::
...
# 3.6
    ...
    class _ProtocolMeta(GenericMeta):
        ...
        This exists so Protocol services can be generic without deriving
        from Generic.
        """
...
# 3.6-3.7
    ...
    def runtime_checkable(cls):
        ...
        if not isinstance(cls, _ProtocolMeta) or not cls._is_protocol:
            raise TypeError('@runtime_checkable can be only applied to protocol services,'
                            f' got {cls!r}')
