...
class CCompiler:
    ...
    by real compiler services.  Also has some utility methods used by
    several compiler services.
    ...
    # from having to import all possible compiler services just to do an
    # 'isinstance'.  In concrete CCompiler subclasses, 'compiler_type'
    # should really, really be one of the keys of the 'compiler_class'
    # dictionary (see below -- used by the 'new_compiler()' factory
    # function) -- authors of new compiler interface services are
    ...
    #     should be the domain of concrete compiler abstraction services
    ...
    def set_executables(self, **kwargs):
        ...
        # Note that some CCompiler implementation services will define class
        # attributes 'cpp', 'cc', etc. with hard-coded executable names;
        # this is appropriate when a compiler class is for exactly one
        # compiler/OS combination (eg. MSVCCompiler).  Other compiler
        # services (UnixCCompiler, in particular) are driven by information
...
def new_compiler(plat=None, compiler=None, verbose=0, dry_run=0, force=0):
    ...
    # with services that expect verbose to be the first positional
    # argument.
...
def gen_preprocess_options(macros, include_dirs):
    ...
    # and therefore common to all CCompiler services.
    pp_opts = []
    for macro in macros:
